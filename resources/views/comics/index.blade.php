                ...
                <tbody>
                    @forelse ($comics as $comic)
                        <tr>
                            ...
                            <td>{{ $comic->type }}</td>
                            <td>
                                <a class="btn btn-dark" href="{{ route('comics.show', $comic) }}"><i class="fas fa-eye fa-sm fa-fw"></i></a>
                                <a class="btn btn-dark" href="{{ route('comics.edit', $comic)}}"><i class="fas fa-pencil-alt fa-sm fa-fw"></i></a>
